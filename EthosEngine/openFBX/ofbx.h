...
struct Object
{
	...
	std::vector<const Object*> getChildren() const;
	...
	const Object* node_attribute = nullptr;
...
struct TakeInfo
{
	DataView name;
	DataView filename;
	double local_time_from = 0.0;
	double local_time_to = 0.0;
	double reference_time_from = 0.0;
	double reference_time_to = 0.0;
};
...
{
	UpVector UpAxis = UpVector::UpVector_AxisX;
	int UpAxisSign = 1;
	FrontVector FrontAxis = FrontVector::FrontVector_ParityOdd;
	int FrontAxisSign = 1;
	CoordSystem CoordAxis = CoordSystem::CoordSystem_RightHanded;
	int CoordAxisSign = 1;
	...
	FrameRate TimeMode = FrameRate::FrameRate_DEFAULT;
