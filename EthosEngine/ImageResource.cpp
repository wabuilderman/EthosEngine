...
ImageResource::ImageResource(uint32_t width, uint32_t height, uint32_t mipLevels, VkFormat format, VkImageTiling tiling,
	VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImageAspectFlags aspectMask) {
	createImage(width, height, mipLevels, format, tiling, usage, properties);
	...
	DebugManager::message("Image created");
}
#pragma warning(pop)
...
ImageResource::~ImageResource() {
	...
	DebugManager::message("Image destroyed");
}

void ImageResource::createImage(uint32_t width, uint32_t height, uint32_t mipLevels, VkFormat format, VkImageTiling tiling,
...
#pragma warning(push)
#pragma warning(disable:26812)
void ImageResource::transitionImageLayout(VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout, uint32_t mipLevels) {
...
#pragma warning(pop)
void ImageResource::copyBufferToImage(VkBuffer buffer, uint32_t width, uint32_t height) {
	VkCommandBuffer commandBuffer = CommandPool::beginOneTimeCommand();
